...
urlpatterns = [
    ...
    path('products/search/', views.ProductList, name='search'),
    path('products/<slug:collection_slug>/', views.ProductList, name='collection'),
    path('products/', views.ProductList, name='products'),
    path('product/<str:sku>/', views.ProductDetail, name='product_detail'),
